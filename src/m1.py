...
class CircleChanger(object):
    ...
    def swallow(self, other_circle_changer):
        ...
        return CircleChanger(center.x, center.y, r, 'red', self.colors + other_circle_changer.colors)
    ...
    def change_to_next_color_in_tuple(self):
        ...
        ################################################################
        self.circle.fill_color = self.colors[self.init_index]
        self.init_index += 1
        if self.init_index == len(self.colors):
            self.init_index = 0
